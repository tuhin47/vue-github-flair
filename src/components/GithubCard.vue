<template>
  <div class="github-card">
    ...
    <template v-if="msg.length > 0">
      <div class="github-card-profile">
        <div class="github-card-error" v-html="msg"></div>
      </div>
    </template>
    <template v-if="isFoundProfile === true">
      <div class="github-card-profile">
        <div class="github-card-header">
          ...
          <div class="github-card-name">
            <a v-bind:href="profile.url" target="_blank">{{ profile.name }}</a>
          </div>
        ...
        <div class="github-card-status">
          <div class="github-card-item">
            <a v-bind:href="profile.reposUrl" target="_blank">
              <strong class="github-card-item-count">{{
                profile.repos
              }}</strong>
    ...
    <template v-if="isFoundProfile === true && repos.length">
      <div class="github-card-repos">
        ...
        <div class="github-card-repo" v-for="(repo, i) in repos" :key="i">
          ...
          <div class="github-card-item github-card-repo-language">
            {{ repo.language }}
          </div>
